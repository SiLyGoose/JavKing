...
public class play extends AbstractPlayCommand {
    ...
    public void execute(CommandContext context) throws Exception {
        ...
        instance.getCommandManager()
                .executeCommand("join", context, instance.getExecutionQueueManager().getForGuild(guild));
...
//
        audioManager.startPlaying(guild, audioManager.getPlaybackForGuild(guild).isPlaying());
    }
