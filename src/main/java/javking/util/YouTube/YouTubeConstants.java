...
public class YouTubeConstants {
    static final String INNERTUBE_API_KEY = PropertiesLoadingService.requireProperty("V3_API_KEY");
    ...
    static final String THUMBNAIL_BASE_PREFIX = "https://i.ytimg.com/vi/";
    static final String THUMBNAIL_HQDEFAULT_SUFFIX = "/hqdefault.jpg";
    static final String THUMBNAIL_MAXRES_SUFFIX = "/maxresdefault.jpg";

    static final String VIDEO_URL_PREFIX = YOUTUBE_ORIGIN + "/watch?v=";
